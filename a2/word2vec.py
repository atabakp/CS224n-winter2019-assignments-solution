...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    loss = 0.0
    gradCenterVecs = np.zeros(centerWordVectors.shape)   # (5,3)
    gradOutsideVectors = np.zeros(outsideVectors.shape)  # (5,3)
    ...
    for outside_word in outsideWords:
        ...
        word2vecLossAndGradient(v_center, outsideWordIdx, outsideVectors, dataset)
        loss += each_loss
